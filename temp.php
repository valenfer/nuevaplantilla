...
<body>
    ...
    <div style="
        ...
        color: #2e7d32;
    ">
        <strong>Información:</strong> Actualmente estás configurando un nuevo sorteo que será accesible desde: ' . $url . '
    </div>';
        }
        ?>
        ...
        <div class="section">
            <h3>Datos</h3>
            <ul>
                <li>Archivos de imágenesde los premios</li>
                <li>Ten en cuenta la cantidad de cada uno</li>
        ...
        <div class="section">
            ...
            <ul>
                ...
                <li>Si se permite repetir un teléfono el mismo día</li>
